...
using atividade_Avaliativa.Factories;
    ...
    class Program
    {
        ...
        {            
            ...
            try
            {
                ...
                Pedido pedidoGabriel = pedidoFactory.CriarPedido(1, clienteGabriel, new List<ItemPedido> { itemLapis, itemCaneta }, DateTime.Now);
                Pedido pedidoMiguel = pedidoFactory.CriarPedido(2, clienteMiguel, new List<ItemPedido> { itemCaneta }, DateTime.Now);

                Relatorio relatorio = new Relatorio(new List<Pedido> { pedidoGabriel, pedidoMiguel });
